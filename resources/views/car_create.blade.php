    ...
    <div id="bodyOfTable" class="ml-40 mt-20 text-xl">
      ...
      <form method="POST" action="{{ route('cars.store') }}" class="justify-self-center flex ml-150 my-33">
        ...
        <div class="h-168 w-130 bg-linear-to-t/shorter from-red-500 to-rose-950 rounded-2xl shadow-xl shadow-red-700/60">
          ...
          <input type="text" name="car_model" placeholder="Modelo do carro *" style="font-family: Nunito" class="justify-self-center flex rounded-xl w-80 h-12 pl-2 mt-8 text-slate-50 bg-indigo-950" required autofocus>

          <input type="number" name="car_odometer" placeholder="Quilometragem *" style="font-family:Nunito" class="justify-self-center flex rounded-xl w-80 h-12 pl-2 mt-8 text-slate-50 bg-indigo-950" required>

          <input type="number" name="car_fabrication_year" placeholder="Ano de fabricação *" style="font-family: Nunito" class="justify-self-center flex rounded-xl w-80 h-12 pl-2 mt-8 text-slate-50 bg-indigo-950" required>

          <input type="text" name="car_fabricator" placeholder="Marca *" style="font-family:Nunito" class="justify-self-center flex rounded-xl w-80 h-12 pl-2 mt-8 text-slate-50 bg-indigo-950" required>

          <input type="text" name="car_category" placeholder="Categoria *" style="font-family:Nunito" class="justify-self-center flex rounded-xl w-80 h-12 pl-2 mt-8 text-slate-50 bg-indigo-950" required>

          <input type="text" name="car_rental_value" placeholder="Valor para aluguel *" style="font-family:Nunito" class="justify-self-center flex rounded-xl w-80 h-12 pl-2 mt-8 text-slate-50 bg-indigo-950" required>
